...
// CountryCode is an ISO 3166-1 alpha-2 country code and its official short name.
// Used by certificate subject Country (C) field and for UI datalist/reference.
type CountryCode struct {
	Code string
	Name string
}

// CountryCodes is the full ISO 3166-1 alpha-2 list (code → name).
// Single source of truth for datalist and reference table in templates.
var CountryCodes = []CountryCode{
	...
	{"CD", "DR Congo"}, {"CF", "Central African Republic"}, {"CG", "Republic of the Congo"},
	...
	{"TF", "French Southern and Antarctic Lands"}, {"TG", "Togo"},
